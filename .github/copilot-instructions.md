# GitHub Copilot Instructions -- 32-logging
...
4. **Query the data model** for this project's record:
   `powershell
   Invoke-RestMethod "http://localhost:8010/model/projects/32-logging" | Select-Object id, maturity, notes
   `
...
Invoke-RestMethod "http://localhost:8010/model/endpoints/" |
  Where-Object { $_.implemented_in -like '*32-logging*' } |
